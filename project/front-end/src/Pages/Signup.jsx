    ...
    <div className='flex justify-center items-center w-full h-screen bg-gray-200'>
      <div className="flex flex-col justify-center items-center w-70 h-80 p-4 bg-white rounded-xl">
        ...
        <form onSubmit={handleSubmit} className="flex w-full flex-col gap-4">
          ...
          <button disabled={loading} type="submit" className={`bg-gray-900 text-white cursor-pointer py-1.5 px-2 text-sm rounded hover:bg-gray-800 duration-300 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}>
